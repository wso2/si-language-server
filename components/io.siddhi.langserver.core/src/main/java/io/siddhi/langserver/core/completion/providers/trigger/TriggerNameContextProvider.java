...
package io.siddhi.langserver.core.completion.providers.trigger;
...
/**
 * Provide completions for TriggerNameContext. {@link io.siddhi.query.compiler.SiddhiQLParser.Trigger_nameContext}.
 *
 * @since 1.0.0
 */
public class TriggerNameContextProvider extends CompletionProvider {
    ...
    public List<CompletionItem> getCompletions() {
        ...
        suggestions.add(SnippetBlockUtil.SNIPPETS.get("TRIGGER_NAME_SNIPPET"));
