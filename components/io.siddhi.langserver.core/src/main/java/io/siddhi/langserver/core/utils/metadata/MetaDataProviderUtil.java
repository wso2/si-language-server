...
/**
 * {@code MetaDataProviderUtil} is a utility class for getting meta data for the in built and extension processors in
 * Siddhi.
 *
 * @since 1.0.0
 */
public class MetaDataProviderUtil {
    ...
    /**
     * Returns the in built processor meta data. Scans for all classes in all jars in the classpath.
     *
    ...
    /**
     * Get the processor metadata of extensions at the classpath. Returns the extension processor meta data. Gets the
     * meta data from the Siddhi Manager.
     *
    ...
    /**
     * populate the targetProcessorMetaDataList with the annotated data in the classes in the class map for the
     * specified processor type.
     *
     * @param targetProcessorMetaDataList List of processor meta data objects to populate
     * @param classMap                    processor types to set of class map from which the metadata should be
     *                                    extracted
    ...
    /**
     * Generate processor meta data from the annotated data in the class. This generates a processor name using the
     * class name
     *
    ...
    /**
     * Generate a MetaData object map using the class map provided for extension processors. The return map's key is the
     * namespace and the meta data object contains the different types of processors
     *
