...
import io.siddhi.langserver.core.utils.metadata.AttributeMetaData;
import io.siddhi.langserver.core.utils.metadata.ParameterMetaData;
import io.siddhi.langserver.core.utils.metadata.ProcessorMetaData;
...
/**
 * SnippetBlock class provides pre defined  snippet block objects to be generated to completion items. Each completion
 * snippet consists of an array of {insertText,label,completionItemKind,details,filterText,insertTextFormat}.
 *
 * @since 1.0.0
 */
