...
public class AttributeReferenceContextProvider extends ScopeCompletionProvider {
    ...
    /**
     * Finds the list of attributes of defined sources in Siddhi App context  and returns a map of source to list of
     * attributes given the possible source names which has been defined in the scope of the sourceProvider Contexts.
     *
    ...
    /**
     * Provide completions for WindowContext. {@link SiddhiQLParser.WindowContext}.
     */
