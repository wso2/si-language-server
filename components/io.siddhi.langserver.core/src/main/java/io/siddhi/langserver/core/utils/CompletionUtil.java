...
import io.siddhi.langserver.core.DocumentManager;
...
import io.siddhi.langserver.core.completion.providers.siddhiapp.ParseContextProvider;
import io.siddhi.langserver.core.parser.LanguageServerParser;
...
/**
 * Provides the interface for the processes of compilation of source code and retrieval of respective completion items
...
public class CompletionUtil {
    ...
    /**
     * Integrates compilation and completionItem generation, returns a list of completion items given the source content
     * and current cursor position {@link CompletionParams}.
     *
     ...
     * ParseTree. {@link Map<String, ParseTree>} and store it in the {@link LSCompletionContext}
     */
