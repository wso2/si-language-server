...
/**
 * Provides completions for FunctionBodyContext. {@link io.siddhi.query.compiler.SiddhiQLParser.Function_bodyContext}.
 *
 * @since 1.0.0
 */
public class FunctionBodyContextProvider extends CompletionProvider {
    ...
    public List<CompletionItem> getCompletions() {
        ...
        suggestions.add(SnippetBlockUtil.SNIPPETS.get("FUNCTION_BODY_SNIPPET"));
