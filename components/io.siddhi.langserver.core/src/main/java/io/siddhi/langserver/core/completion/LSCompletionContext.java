...
public class LSCompletionContext {
    ...
    /**
     * sets the returned tree traversing pattern and set the current context which is at the bottom of the search path
     * of the returned tree path. Identify the terminal context {@link TerminalNodeImpl} or {@link LSErrorNode} and sets
     * them if available.
     *
