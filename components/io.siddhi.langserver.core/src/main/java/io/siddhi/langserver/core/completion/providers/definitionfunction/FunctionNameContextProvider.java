...
/**
 * Provides completions for FunctionNameContext. {@link io.siddhi.query.compiler.SiddhiQLParser.Function_nameContext}.
 *
 * @since 1.0.0
 */
public class FunctionNameContextProvider extends CompletionProvider {
    ...
    public List<CompletionItem> getCompletions() {
        ...
        suggestions.add(SnippetBlockUtil.SNIPPETS.get("FUNCTION_NAME_SNIPPET"));
